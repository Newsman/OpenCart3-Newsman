...
$_['entry_complete_order_status'] = 'Statuts de commande signalés comme terminés';
$_['entry_complete_order_status_help'] = 'Statuts de commande signalés à Newsman comme achat terminé, en plus du réglage de la boutique \'Statut de commande terminée\'. À utiliser lorsque le statut final d\'une commande est un statut que la boutique ne compte pas comme terminé, par exemple un statut d\'expédition ou de remise au transporteur. Les statuts absents des deux listes sont envoyés à Newsman sous leur propre nom.';
$_['entry_processing_order_status'] = 'Statuts de commande signalés comme en cours';
$_['entry_processing_order_status_help'] = 'Statuts de commande signalés à Newsman comme achat en cours, en plus du réglage de la boutique \'Statut de commande en cours\'. Un statut coché comme terminé ci-dessus l\'emporte sur un statut coché ici. Les statuts absents des deux listes sont envoyés à Newsman sous leur propre nom.';
