...
$_['entry_complete_order_status'] = 'Orderstatusar som rapporteras som slutförda';
$_['entry_complete_order_status_help'] = 'Orderstatusar som rapporteras till Newsman som ett slutfört köp, utöver butiksinställningen \'Status för slutförd order\'. Använd detta när en orders slutstatus är en som butiken inte räknar som slutförd, till exempel en leverans- eller överlämningsstatus. Statusar som saknas i båda listorna skickas till Newsman under sitt eget namn.';
$_['entry_processing_order_status'] = 'Orderstatusar som rapporteras som pågående';
$_['entry_processing_order_status_help'] = 'Orderstatusar som rapporteras till Newsman som ett pågående köp, utöver butiksinställningen \'Status för order under behandling\'. En status som kryssats i som slutförd ovan går före en som kryssats i här. Statusar som saknas i båda listorna skickas till Newsman under sitt eget namn.';
