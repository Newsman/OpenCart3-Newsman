...
$_['entry_complete_order_status'] = 'Estados de pedido reportados como completados';
$_['entry_complete_order_status_help'] = 'Estados de pedido reportados a Newsman como compra completada, además del ajuste de la tienda \'Estado de pedido completado\'. Úselo cuando el estado final de un pedido sea uno que la tienda no cuenta como completado, por ejemplo un estado de envío o de entrega al mensajero. Los estados que no están en ninguna de las dos listas se envían a Newsman con su propio nombre.';
$_['entry_processing_order_status'] = 'Estados de pedido reportados como en proceso';
$_['entry_processing_order_status_help'] = 'Estados de pedido reportados a Newsman como compra en curso, además del ajuste de la tienda \'Estado de pedido en proceso\'. Un estado marcado arriba como completado tiene prioridad sobre uno marcado aquí. Los estados que no están en ninguna de las dos listas se envían a Newsman con su propio nombre.';
