...
$_['entry_complete_order_status'] = 'Stări de comandă raportate ca finalizate';
$_['entry_complete_order_status_help'] = 'Stările de comandă raportate către Newsman ca achiziție finalizată, pe lângă setarea magazinului \'Stare comandă finalizată\'. Folosește această opțiune când starea finală a unei comenzi este una pe care magazinul nu o consideră finalizată, de exemplu o stare de expediere sau de predare către curier. Stările care nu apar în niciuna dintre liste sunt trimise către Newsman sub propriul nume.';
$_['entry_processing_order_status'] = 'Stări de comandă raportate ca în procesare';
$_['entry_processing_order_status_help'] = 'Stările de comandă raportate către Newsman ca achiziție în curs, pe lângă setarea magazinului \'Stare comandă în procesare\'. O stare bifată mai sus ca finalizată are prioritate față de una bifată aici. Stările care nu apar în niciuna dintre liste sunt trimise către Newsman sub propriul nume.';
