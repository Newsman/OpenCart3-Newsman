...
$_['entry_complete_order_status'] = 'Als abgeschlossen gemeldete Bestellstatus';
$_['entry_complete_order_status_help'] = 'Bestellstatus, die zusätzlich zur Shop-Einstellung \'Bestellstatus abgeschlossen\' als abgeschlossener Kauf an Newsman gemeldet werden. Verwenden Sie dies, wenn der Endstatus einer Bestellung einer ist, den der Shop nicht als abgeschlossen zählt, etwa ein Versand- oder Übergabestatus. Status, die in keiner der beiden Listen stehen, werden unter ihrem eigenen Namen an Newsman gesendet.';
$_['entry_processing_order_status'] = 'Als in Bearbeitung gemeldete Bestellstatus';
$_['entry_processing_order_status_help'] = 'Bestellstatus, die zusätzlich zur Shop-Einstellung \'Bestellstatus in Bearbeitung\' als laufender Kauf an Newsman gemeldet werden. Ein oben als abgeschlossen markierter Status hat Vorrang vor einem hier markierten. Status, die in keiner der beiden Listen stehen, werden unter ihrem eigenen Namen an Newsman gesendet.';
