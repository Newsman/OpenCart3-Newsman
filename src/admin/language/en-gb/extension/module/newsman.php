...
$_['entry_complete_order_status'] = 'Order Statuses Reported as Complete';
$_['entry_complete_order_status_help'] = 'Order statuses reported to Newsman as a completed purchase, on top of the store \'Complete Order Status\' setting. Use it when the final status of an order is one the store does not count as complete, such as a shipped or handed-to-courier status. Statuses in neither list are sent to Newsman under their own name.';
$_['entry_processing_order_status'] = 'Order Statuses Reported as Processing';
$_['entry_processing_order_status_help'] = 'Order statuses reported to Newsman as a purchase in progress, on top of the store \'Processing Order Status\' setting. A status ticked as complete above wins over one ticked here. Statuses in neither list are sent to Newsman under their own name.';
