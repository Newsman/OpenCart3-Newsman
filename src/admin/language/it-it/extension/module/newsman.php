...
$_['entry_complete_order_status'] = 'Stati ordine segnalati come completati';
$_['entry_complete_order_status_help'] = 'Stati ordine segnalati a Newsman come acquisto completato, oltre all\'impostazione del negozio \'Stato ordine completato\'. Da usare quando lo stato finale di un ordine è uno che il negozio non considera completato, ad esempio uno stato di spedizione o di consegna al corriere. Gli stati assenti da entrambe le liste vengono inviati a Newsman con il proprio nome.';
$_['entry_processing_order_status'] = 'Stati ordine segnalati come in elaborazione';
$_['entry_processing_order_status_help'] = 'Stati ordine segnalati a Newsman come acquisto in corso, oltre all\'impostazione del negozio \'Stato ordine in elaborazione\'. Uno stato spuntato sopra come completato ha la precedenza su uno spuntato qui. Gli stati assenti da entrambe le liste vengono inviati a Newsman con il proprio nome.';
